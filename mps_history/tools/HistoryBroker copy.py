...
#         #message = Message(2, 378, 0, 0, 17)  # input
...
#                 fault_info = {"type":"fault", "timestamp": self.timestamp, "active":False, "fault_id":message.id, "fault_desc":("FAULT CLEARED - " + fault.name)}
#             else:
#                 fault_info = {"type":"fault", "timestamp": self.timestamp, "active":True, "fault_id":fault.id, "fault_desc":fault.name}
#             print(fault_info)
...
#             # TODO - Make function that returns "channel_info" and append it here
...
#                 self.timestamp = self.timestamp = str(datetime.now())
